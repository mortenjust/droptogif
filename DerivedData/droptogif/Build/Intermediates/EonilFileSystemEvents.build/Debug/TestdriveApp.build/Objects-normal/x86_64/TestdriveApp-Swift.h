...
SWIFT_CLASS("_TtC12TestdriveApp11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate, NSTableViewDataSource, NSTableViewDelegate, NSControlTextEditingDelegate>
...
- (void)applicationDidBecomeActive:(NSNotification * __nonnull)notification;
- (void)applicationWillResignActive:(NSNotification * __nonnull)notification;
